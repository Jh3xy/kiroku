...
import { getTrendingAnime, searchAnime } from "./api.js";
import { renderHero, renderGrid } from "./render.js";
 ...
 * */
function showLoadingState({ showHero }) {
...
function loadBrowse() {
  ...
  showLoadingState({ showHero: true });
...
searchInput.addEventListener("input", () => {
  ...
  showLoadingState({ showHero: false });
